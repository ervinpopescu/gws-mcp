...
Executable script location: `skills/gws-docs/gdocs_builder.py` (or `<skill-path>/gdocs_builder.py`)

### 1. Read & Parse Google Doc to Markdown

```bash
python3 skills/gws-docs/gdocs_builder.py read <DOCUMENT_ID>
```
...
```bash
python3 skills/gws-docs/gdocs_builder.py render <DOCUMENT_ID> /path/to/content.md
```

Or via pipeline stdin:

```bash
cat << 'EOF' | python3 skills/gws-docs/gdocs_builder.py render <DOCUMENT_ID> -
# Document Title
## Document Subtitle
*Scope: ...*
...
```bash
python3 skills/gws-docs/gdocs_builder.py create "Document Title"
```

### 4. Clear a Document

```bash
python3 skills/gws-docs/gdocs_builder.py clear <DOCUMENT_ID>
```
